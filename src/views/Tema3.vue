  ...
  .curso-main-container.pb-3
    ...
    .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
      ...
      p.mb-5 Esta codificación se desarrolla en un anuncio donde radica la fuerza visual y el 
        ...
        i copy 
        | quien redacta los textos que aparecen en el anuncio publicitario.
          ...
          SlyderF(columnas="col-lg-6 col-xl-6 col-md-6")
            .tarjeta.tarjeta--grisclaro.p-4 
              ...
              p.text-center Se estudió un 
                i briefing 
                | creativo y mediante la aplicación de la técnica de 100 mph 
                i thinking, 
                | donde se generaron tantas ideas visuales como se pudo en un tiempo limitado.
  
            .tarjeta.tarjeta--grisclaro.p-4
              h2.big 02
              p.text-center Se eligió una idea y se desarrolló un boceto.
